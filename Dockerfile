...
RUN apt update
RUN apt install -y git pkg-config autoconf automake libtool make build-essential python3 libssl-dev libtatsu-dev upx-ucl curl libcurl4-openssl-dev librust-curl*
